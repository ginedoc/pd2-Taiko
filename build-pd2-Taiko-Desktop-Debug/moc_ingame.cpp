...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_InGame_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_InGame_t qt_meta_stringdata_InGame = {
    {
QT_MOC_LITERAL(0, 0, 6) // "InGame"
...
const QMetaObject InGame::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_InGame.data,
      qt_meta_data_InGame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InGame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InGame.stringdata0))
